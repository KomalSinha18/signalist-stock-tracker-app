...
```bash
git clone https://github.com/KomalSinha18/signalist-stock-tracker-app.git
```
...
- [Better Auth](https://www.better-auth.com/) for simplifying authentication
- [Shadcn UI](https://ui.shadcn.com/docs) for beautiful React components
